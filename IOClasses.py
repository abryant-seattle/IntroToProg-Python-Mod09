...
# ABryant,6.13.2020,Modified IOClasses module to import to Main.py
# ABryant,6.14.2020,Caught input_employee_data error, return statement was in except block instead of try statement
# ---------------------------------------------------------- #
...
class EmployeeIO:
    ...
    def input_employee_data():
        ...
        try:
            ...
            first_name = str(input("What is the employee First Name? - ").strip()).title()
            last_name = str(input("What is the employee Last Name? - ").strip()).title()
            print()  # Add an extra line for looks
